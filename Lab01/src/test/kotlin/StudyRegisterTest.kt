...
internal class StudyRegisterTest {
    ...
    fun createStudents() {
        ...
        student.addCourse(StudyRegister.CourseRecord("Kotlin basics", 2023, 5, 5.0))
        student.addCourse(StudyRegister.CourseRecord("Java basics", 2023, 5, 1.0))
        student.addCourse(StudyRegister.CourseRecord("Scala basics", 2023, 3, 2.0))
        students.add(student)
        student = Student("Abebe Bikila", 23)
        student.addCourse(StudyRegister.CourseRecord("Kotlin basics", 2023, 5, 2.0))
        students.add(student)
        student = Student("Günther Radulic", 20)
        student.addCourse(StudyRegister.CourseRecord("Kotlin basics", 2023, 5, 4.0))
        student.addCourse(StudyRegister.CourseRecord("Kotlin advanced", 2023, 5, 5.0))
        students.add(student)
    }
    @Test
    fun testHuman() {
        val a = StudyRegister.Human("Abebe Bikila", 21)
    ...
    fun testMajor() {
        createStudents()
        val major = StudyRegister.Major("True Programming")
