...
internal class ComplexTest {
    ...
    fun testMinus() {
        val a = Complex(1.0,2.0)
        val b = Complex(3.0,4.0)
        assert((a - b) == Complex(-2.0,-2.0))
    }

    @Test
    fun testTimes1() {
        val a = Complex(0.0,1.0)
        val b = Complex(0.0,1.0)
        assert((a * b) == Complex(-1.0,0.0))
    }
    ...
    fun testTimes3() {
        val a = Complex(1.0,2.0)
        val b = Complex(1.0,-2.0)
        assert((a * b) == Complex(5.0,0.0))
    }

    @Test
    fun testAbs1() {
        val a = Complex(1.0,0.0)
